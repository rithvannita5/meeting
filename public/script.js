...
function sendScreenToPeer(peerId) {
  ...
  try {
    ...
    console.log('📺 Sending screen to peer:', peerId);
  } catch (err) {
...
function startSocketScreenFallbackFromExistingStream() {
  ...
  try { screenFallbackVideo.play(); } catch (e) {}
